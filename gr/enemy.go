...
func (this *EnemyState) setAppearancePos(field Field, ship Ship, appType AppearanceType /*= AppearanceTypeTOP*/) bool {
...
func (this *EnemySpec) score() int {
	return 0
}

func (this *EnemySpec) isBoss() bool {
